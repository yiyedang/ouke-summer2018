...
/**
 * This is a Grid data structure made to better represent 2-D matrix.
 * It provides many functionalities as useful methods so that clients
 * do not need to care about the index operators or index out of bounds
 * exception. 
 * 
 * NOTE: This grid idea originates from Stanford C++ Library.
 * 
 * @author hanjiedeng
 * @version 1.0
 * */
